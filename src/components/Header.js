...
const Header = () => {
  return (
    ...
    <div className="container-fluid">
      <p className="brand-logo"> SCOTT RENTAL</p>
        <ul className="navbar-nav mx-end ">
          ...
          <a className="nav-link dropdown-toggle justify-content-end" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Profile
          </a>
